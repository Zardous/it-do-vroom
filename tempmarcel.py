...
exercise_data = {
    'Case 1': [150, 400, 0.8, 0.7, 2.2, 0.920833, 1, 15, 820, 0, 0.12, 100, 45, 0.01, 32, 100, 0.5, 10.5, 'earth'],
    'Case 2': [100, 400, 0.8, 0.7, 2.2, 0.920833, 4.2, 15, 100, 0, 0.1, 10, 45, 0.05, 8, 75, 8, 10.5, 'moon'],
    'Case 3': [10, 400, 0.8, 0.7, 8.4, 0.851136, 0.1, 35, 1000, 5, 1, 0.01, 10, 0.2, 8, 5, 18, 10.5, 'mars'],
    'Case 4': [100, 1000, 0.8, 0.7, 8.4, 0.851136, 2, 35, 400, 20, 0.1, 1, 10, 0.1, 8, 10, 18, 10.5, 'mars'],
    'Case 5': [200, 1000, 0.8, 0.7, 8.5, 0.851136, 1.6, 35, 1000, 10, 0.1, 1, 10, 0.3, 8, 25, 12, 10.5, 'venus']
}
...
def g_over_t(values, f, D, T_0, c, eta_ant):
    T_sys = 10 * np.log10(T_0 * (1 - values[3]))
    gain = 10 * np.log10(eta_ant * ((np.pi * D) / (c / f)) ** 2)
    g_over_t = gain - T_sys
    return g_over_t
